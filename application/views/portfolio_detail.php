...
<section id="services" class="services">
  <div class="container" data-aos="fade-up">
    ...
    <div class="section-header">
     ...
     <h4 style="text-align: justify;">The following pictures are sparks that tells about what we did before and doing now. We are experienced on the development of websites, web applications, Mobile applications, AI applications. We are also talented on network installation and configration, offering clear and precise lectures, research and project advissing.</h4>
  </div>
    ...
    <center>
        <div class="col-lg-8">
            ...
            <article class="blog-details">
              <div class="post-img">
                <h3 class="title"><?php echo $portfolio_detail->skill; ?></h3>
                <img src="<?php echo site_url();?>assets/portfolio/<?php echo $portfolio_detail->p_file;?>" class="img-fluid"  style="position: relative;">
            </div>

            <h3 class="title"><?php echo $portfolio_detail->title; ?></h3>

            <div class="meta-top">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="blog-details.html"><time datetime="2020-01-01"><?php echo $portfolio_detail->post_date; ?></time></a></li>
              </ul>
          </div><!-- End meta top -->

          <div class="content">
           <h5 style="max-height: 200px;overflow:; padding-bottom: 1px;text-align: justify;"><?php echo $portfolio_detail->description; ?></h5>
