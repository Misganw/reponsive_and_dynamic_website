...
<section id="recent-blog-posts" class="recent-blog-posts">
  ...
  <div class="container" data-aos="fade-up">
    ...
    <div class="section-header">
      <h2>News</h2>
      <p>In this page, administrator can add new post, update and delete the posts. One thing to underline that, <strong>HTML code does not exixt as the previous form</strong>. So, the admin should replace the HTML code part by the orginal code.</p>
    </div>
    ...
    <div class="row">
      ...
      foreach($blog_list->result() as $row)
      {
       ...
       <hr>
          ...
          <div class="post-box">
            <div class="post-img"><img src="<?php echo site_url();?>assets/blogs/<?php echo $row->image ?>" class="img-fluid" alt=""></div>
            <div class="meta">
              <span class="post-date"><?php echo $row->post_date ?></span>
              <span class="post-author"> /<?php echo 'Posted By: '.$row->upload_by ?></span>
            </div>
