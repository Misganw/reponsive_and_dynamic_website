...
<section id="services" class="services">
  <div class="container" data-aos="fade-up">
    ...
    <div class="section-header">
     ...
     <h4 style="text-align: justify;">Certificate that shows about what we did before and get reward. We are experienced on the development of websites, web applications, Mobile applications, AI applications. We are also talented on network installation and configration, offering clear and precise lectures, research and project advising.</h4>
  </div>
    ...
    <center>
        <div class="col-lg-8">
            ...
            <article class="blog-details">
              <div class="post-img">
                <h3 class="title"><?php echo $certificate_detail->skill; ?></h3>
                <img src="<?php echo site_url();?>assets/certificate/<?php echo $certificate_detail->p_file;?>" class="img-fluid"  style="height: 400px; width: 600px;">
            </div>

            <h3 class="title"><?php echo $certificate_detail->title; ?></h3>

            <div class="meta-top">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="blog-details.html"><time datetime="2020-01-01"><?php echo $certificate_detail->post_date; ?></time></a></li>
              </ul>
          </div><!-- End meta top -->
